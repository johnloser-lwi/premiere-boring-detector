...
# Boring Detector — Dev Setup Script

# Write-Host "================================================" -ForegroundColor Cyan
# Write-Host " Boring Detector CEP Extension — Dev Setup"     -ForegroundColor Cyan
# Write-Host "================================================" -ForegroundColor Cyan
# Write-Host ""
...
$linkPath   = Join-Path $extensionsDir "BoringDetector"
...
# Write-Host ' Window > Extensions > Boring Detector'
# Write-Host "================================================" -ForegroundColor Cyan